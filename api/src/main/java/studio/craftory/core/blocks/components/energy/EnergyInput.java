...
public interface EnergyInput extends EnergyStorage {
   ...
   *
   * @param availableEnergy Amount of energy that is available to be inserted into objects energy storage
   * @return Amount of energy that was stored
   */
  default long receiveEnergy(final long availableEnergy) {
    synchronized (this) {
