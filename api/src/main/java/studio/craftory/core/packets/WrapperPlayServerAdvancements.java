package studio.craftory.core.packets;
...
public class WrapperPlayServerAdvancements extends AbstractPacket {
  ...
  public static class Advancements {
    ...
    public Map<MinecraftKey, SerializedAdvancement> advancements;
    public Set<MinecraftKey> toRemove;
    public Map<MinecraftKey, AdvancementProgress> advancementProgress;
  }
  ...
  private static final AutoWrapper<SerializedAdvancement> ADVANCEMENT = AutoWrapper
  ...
  private static final AutoWrapper<Advancements> WRAPPER = AutoWrapper
      .wrap(Advancements.class, "PacketPlayOutAdvancements")
      .field(0, Converters.passthrough(Boolean.class))
      .field(1, BukkitConverters.getMapConverter(MinecraftKey.getConverter(), ADVANCEMENT))
      .field(3, BukkitConverters.getMapConverter(MinecraftKey.getConverter(), PROGRESS));
  ...
  public Optional<Map<MinecraftKey, SerializedAdvancement>> getAdvancements() {
    return handle.getMaps(MinecraftKey.getConverter(), ADVANCEMENT).optionRead(0);
  }

  public void setAdvancements(Map<MinecraftKey, SerializedAdvancement> value) {
    handle.getMaps(MinecraftKey.getConverter(), ADVANCEMENT).writeSafely(0, value);
  }
